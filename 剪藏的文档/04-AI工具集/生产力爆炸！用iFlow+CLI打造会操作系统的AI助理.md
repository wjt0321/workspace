...
title: 生产力爆炸！用iFlow CLI打造会操作系统的AI助理
date: 2025-11-23
...
# 生产力爆炸！用iFlow CLI打造会操作系统的AI助理

Original oracle [云中志](javascript:void(0);)*2025年11月23日 18:43* *陕西*
...
- 无法完成复杂操作，比如集成 MCP 服务，完成更高级的操作，比如完成一个需求的完整全链路——需求分析、技术架构、代码编写等 当然随着 AI 应用的发展，目前市面上已经有了很多成熟的 AI 应用，可以满足我们复杂的诉求，协助我们完成很多重复的任务，比如 Claude desktop、Cursor 等

    今天我们就以阿里的 iFlow CLI 为例，一起来看看如何高效使用这些工具。
...
![Image](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4icRrJVUgwQHESHaaeBR8RaGbwP4DrBgYwk3Pic45aauerrYCOzZsicyCHQ/640?wx_fmt=jpeg&from=appmsg#imgIndex=0)
...
如果想通过其他方式安装，可以参考官方文档：iflow-cli
...
![Image 1](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4ic74cgElbPEYeibZJOeee89KotpHgrQJc5WpicIyQo5VjFDLoTPZIuJmoQ/640?wx_fmt=jpeg&from=appmsg#imgIndex=1)

然后是选择模型，不清楚就默认：

![Image 2](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4icXSxmGHJ9SKTB6VbAujTwPB3hVzRTh1SfBbBRdIgamZrUictcqcUlXcg/640?wx_fmt=jpeg&from=appmsg#imgIndex=2)
...
- `linux/mac`在`home`目录下，`~/.iflow/settings.json`我的配置文件如下：

    ![Image 3](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4icWJRVRXqSUrgVPUySIbwYeok1NpKsRjPXMHjLLfNQT3MoHMkH3KJpEA/640?wx_fmt=jpeg&from=appmsg#imgIndex=3)
...
![Image 4](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4icp2U1OnJbpTVVic8GCZSHfpHZnAZNUAQIKaM93ubVpFvcYSKx7VJgBsg/640?wx_fmt=jpeg&from=appmsg#imgIndex=4)

#### 安装

我们以`Playwright-MCP`为例，这里只介绍手动安装，这个组件的作用是控制浏览器，完成各种浏览器操作：

![Image 5](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4icJe125Jic29O0JHRSQsUcJibLo4SLt4Otm0ib4MiaSoic1vBib1BwIfd6n6uA/640?wx_fmt=jpeg&from=appmsg#imgIndex=5)
...
![Image 6](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4iczGP7AJArWxZicotRXw1M1icTBvWZolnZ7eZcHvZiavsUicdRr9OjgWW6ag/640?wx_fmt=jpeg&from=appmsg#imgIndex=6)
...
![Image 7](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4icKVRWuR5YeYVhIA5WYKwB3GMwJMS0784yuGDBhtnhFBLhtqQjZia1dpA/640?wx_fmt=jpeg&from=appmsg#imgIndex=7)

![Image 8](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4icPaQCTKuX8u5OhMGebv6kia3pKvicwUV6tjm5yFJsdkYsHBr0IHeicboqw/640?wx_fmt=jpeg&from=appmsg#imgIndex=8)
...
- 直接创建、修改、删除文件
    ...
    ![Image 9](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4icl87v0JwCOXeS7JoCHW6ymqtWCTmpPvVBsriaf4992cniaexwq23gaEAg/640?wx_fmt=jpeg&from=appmsg#imgIndex=9)
...
- 代码注释和文档生成 这里的操作需要安装官方提供的扩展指令，具体操作可以自己研究：

    ![Image 10](https://mmbiz.qpic.cn/mmbiz_jpg/fIr9baMq0mH6IaZ5Tbl5FiapjcGxqiae4ic0LnEbtK1BF8MGicuCCsdeo6icW5fZRMX6h7ib5qdibBGqofSBaw7BibuV6g/640?wx_fmt=jpeg&from=appmsg#imgIndex=10)
