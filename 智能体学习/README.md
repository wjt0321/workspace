  ...
  *从基础理论到实际应用，全面掌握智能体系统的设计与实现*
  ...
  <a href="https://github.com/datawhalechina/Hello-Agents"></a>
  <a href="https://datawhalechina.github.io/hello-agents/"></a>
...
| **第一部分：智能体与语言模型基础** |  |  |
| [1. 初识智能体](1.%20初识智能体.md) | 智能体定义、类型、范式与应用 | ✅ |
| [2. 智能体发展史](2.%20智能体发展史.md) | 从符号主义到 LLM 驱动的智能体演进 | ✅ |
| [3. 大语言模型基础](3.%20大语言模型基础.md) | Transformer、提示、主流 LLM 及其局限 | ✅ |
| **第二部分：构建你的大语言模型智能体** |  |  |
| [4. 智能体经典范式构建](4.%20智能体经典范式构建.md) | 手把手实现 ReAct、Plan-and-Solve、Reflection | ✅ |
| [5. 基于低代码平台的智能体搭建](5.%20基于低代码平台的智能体搭建.md) | 了解 Coze、Dify、n8n 等低代码智能体平台使用 | ✅ |
| [6. 框架开发实践](6.%20框架开发实践.md) | AutoGen、AgentScope、LangGraph 等主流框架应用 | ✅ |
| [7. 构建你的Agent框架](7.%20构建你的Agent框架.md) | 从 0 开始构建智能体框架 | ✅ |
| **第三部分：高级知识扩展** |  |  |
| [8. 记忆与检索](8.%20记忆与检索.md) | 记忆系统，RAG，存储 | ✅ |
| [9. 上下文工程](9.%20上下文工程.md) | 持续交互的"情境理解" | ✅ |
| [10. 智能体通信协议](10.%20智能体通信协议.md) | MCP、A2A、ANP 等协议解析 | ✅ |
| [11. Agentic-RL](11.%20Agentic-RL.md) | 从 SFT 到 GRPO 的 LLM 训练实战 | ✅ |
| [12. 智能体性能评估](12.%20智能体性能评估.md) | 核心指标、基准测试与评估框架 | ✅ |
| **第四部分：综合案例进阶** |  |  |
| [13. 智能旅行助手](13.%20智能旅行助手.md) | MCP 与多智能体协作的真实世界应用 | ✅ |
| [14. 自动化深度研究智能体](14.%20自动化深度研究智能体.md) | DeepResearch Agent 复现与解析 | ✅ |
| [15. 构建赛博小镇](15.%20构建赛博小镇.md) | Agent 与游戏的结合，模拟社会动态 | ✅ |
| **第五部分：毕业设计及未来展望** |  |  |
| [16. 毕业设计](16.%20毕业设计.md) | 构建属于你的完整多智能体应用 | ✅ |
...
- 感谢所有为本项目做出贡献的开发者们 ❤️
  ...
  <a href="https://github.com/datawhalechina/Hello-Agents/graphs/contributors">
    ![](https://contrib.rocks/image?repo=datawhalechina/Hello-Agents)
  </a>

## Star History

    ![Datawhale](./images/star-history-20251117.png)

  ⭐ 如果这个项目对你有帮助，请给我们一个 Star！

## 关于 Datawhale

    ![Datawhale](./images/datawhale.png)
...
---
[🔙 返回目录](目录.md) | [下一章：前言 🔜](%E5%89%8D%E8%A8%80.md)
